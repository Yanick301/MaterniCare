...
CREATE TABLE IF NOT EXISTS public.surveys_sfe (
  ...
  cas_reference TEXT,
  informe_signes_danger BOOLEAN,
  signes_danger_expliques TEXT[],
  conseils_hypertendue TEXT[],
  autre_conseils_hypertendue TEXT,
  difficultes_hta BOOLEAN,
  difficultes_rencontrees TEXT[],
  autre_difficultes TEXT,
...
CREATE TABLE IF NOT EXISTS public.surveys_patientes (
  ...
  deja_cesarisee BOOLEAN,
  nb_cesariennes TEXT,
  accouche_apres_cesarienne BOOLEAN,
